...
- [x] 表示は最新50件まで、古い履歴はページング取得。
  - displayLimit: 20→50件に変更
  - historyPageSize: 20→10件に変更
  - Pull-to-refreshで古い履歴を10件ずつ追加取得
- [x] 長文は最初の1000文字＋「続きを読む」折りたたみで高さ計算を抑制。
  - 1000文字超のメッセージは自動折りたたみ
  - 「続きを読む」/「折りたたむ」ボタンでトグル
  - 折りたたみ時は"..."省略記号を表示
